...
//		price = Utility.round(price, 2);
	...
	public String getPriceString() {
		return Utility.formatCurrencyNumber(price);//Double.toString(price.doubleValue()); //price.toString();
	}
	
	public String getPreviousPriceString() {
		return Utility.formatCurrencyNumber(previousPrice);//Double.toString(previousPrice.doubleValue()); //previousPrice.toString();
	}
	...
	public String getPriceChangeString() {
		return Utility.formatCurrencyNumber(priceChange);//Double.toString(priceChange.doubleValue()); // priceChange.toString();
	}
	...
	public String getPriceChangePercentString() {
		return Utility.formatCurrencyNumber(priceChangePercent);//Double.toString(priceChangePercent.doubleValue()); // priceChangePercent.toString();
	}
